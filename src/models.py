...
#   filename:  https://raw.githubusercontent.com/Indicio-tech/acapy-openapi/0.7.4/openapi.yml
#   timestamp: 2022-07-08T16:25:03+00:00
...
class ConnRecord(BaseModel):
    ...
    connection_protocol: Optional[ConnectionProtocol] = Field(
        None, description='Connection protocol used', example='connections/1.0'
    )
    ...
    invitation_mode: Optional[InvitationMode] = Field(
    ...
    routing_state: Optional[RoutingState] = Field(
    ...
    their_role: Optional[TheirRole] = Field(
...
class ConnectionInvitation(BaseModel):
    ...
    recipientKeys: Optional[List[RecipientKey]] = Field(
        None, description='List of recipient keys'
    )
    routingKeys: Optional[List[RoutingKey]] = Field(
...
class RecipientKey1(RecipientKey):
    pass


class RoutingKey1(RoutingKey):
    pass
...
class CreateInvitationRequest(BaseModel):
    ...
    recipient_keys: Optional[List[RecipientKey1]] = Field(
        None, description='List of recipient keys'
    )
    routing_keys: Optional[List[RoutingKey1]] = Field(
        None, description='List of routing keys'
    )
...
class WalletKeyDerivation(Enum):
    """
    Key derivation
    """
...
class CreateWalletRequest(BaseModel):
    ...
    key_management_mode: Optional[KeyManagementMode] = Field(
        None,
    ...
    wallet_dispatch_type: Optional[WalletDispatchType] = Field(
        None,
    ...
    wallet_key_derivation: Optional[WalletKeyDerivation] = Field(
        None, description='Key derivation', example='RAW'
    )
...
class CreateWalletResponse(BaseModel):
    ...
    key_management_mode: KeyManagementMode1 = Field(
...
class DID(BaseModel):
    ...
    key_type: Optional[KeyType] = Field(
    ...
    posture: Optional[Posture] = Field(
        None,
...
class DIDCreateOptions(BaseModel):
    key_type: KeyType = Field(..., example='ed25519')
...
class DIDEndpointWithType(BaseModel):
    ...
    endpoint_type: Optional[EndpointType] = Field(
        None,
...
class DIFHolder(BaseModel):
    directive: Optional[SubjectIsIssuer] = Field(None, description='Preference')
...
class Filter(BaseModel):
    ...
    exclusiveMaximum: Optional[Dict[str, Any]] = Field(
        None, description='ExclusiveMaximum'
    )
    exclusiveMinimum: Optional[Dict[str, Any]] = Field(
        None, description='ExclusiveMinimum'
    )
    format: Optional[str] = Field(None, description='Format')
    maxLength: Optional[int] = Field(None, description='Max Length', example=1234)
    maximum: Optional[Dict[str, Any]] = Field(None, description='Maximum')
    minLength: Optional[int] = Field(None, description='Min Length', example=1234)
...
class GetNymRoleResponse(BaseModel):
    role: Optional[Role] = Field(None, description='Ledger role', example='ENDORSER')
...
class IndyGEProofPred(BaseModel):
    ...
    p_type: Optional[PType] = Field(None, description='Predicate type')
...
class KeylistUpdateRule(BaseModel):
    action: Action = Field(..., description='Action for specific key', example='add')
...
class LDProofVCDetailOptions(BaseModel):
    ...
    credentialStatus: Optional[CredentialStatusOptions] = Field(
        None,
    ...
    proofPurpose: Optional[str] = Field(
        None,
...
class RecipientKey2(RecipientKey):
    pass
...
class ReceiveInvitationRequest(BaseModel):
    ...
    recipientKeys: Optional[List[RecipientKey2]] = Field(
        None, description='List of recipient keys'
    )
    routingKeys: Optional[List[RoutingKey3]] = Field(
        None, description='List of routing keys'
    )
    serviceEndpoint: Optional[str] = Field(
        None,
...
class RevokeRequest(BaseModel):
    ...
    notify_version: Optional[NotifyVersion] = Field(
        None,
...
class Schema1(BaseModel):
    attrNames: Optional[List[str]] = Field(None, description='Schema attribute names')
    id: Optional[str] = Field(
        None,
        description='Schema identifier',
        example='WgWxqztrNooG92RXvxSTWv:2:schema_name:1.0',
    ...
    seqNo: Optional[int] = Field(
        None, description='Schema sequence number', example=10, ge=1
    )
...
class SchemaSendResult(BaseModel):
    schema_: Schema1 = Field(..., alias='schema', description='Schema definition')
    schema_id: str = Field(
        ...,
        description='Schema identifier',
        example='WgWxqztrNooG92RXvxSTWv:2:schema_name:1.0',
...
class SubmissionRequirements(BaseModel):
    ...
    rule: Optional[Rule] = Field(None, description='Selection')
...
class TAAAcceptance(BaseModel):
    mechanism: Optional[str] = None
    time: Optional[int] = Field(None, example=1640995199, ge=0, le=18446744073709551616)
...
class TransactionJobs(BaseModel):
    transaction_my_job: Optional[TransactionMyJob] = Field(
        None, description='My transaction related job'
    )
    transaction_their_job: Optional[TransactionMyJob] = Field(
        None, description='Their transaction related job'
    )


class TransactionRecord(BaseModel):
    _type: Optional[str] = Field(None, description='Transaction type', example='101')
    connection_id: Optional[str] = Field(
        None,
...
class W3CCredentialsListRequest(BaseModel):
    ...
    types: Optional[List[Type1]] = None
...
class Credential(BaseModel):
    _context: List[Union[Dict[str, Any], str]] = Field(
        ...,
        alias='@context',
    ...
    credentialSubject: Dict[str, Any] = Field(..., example='')
...
class DIDCreate(BaseModel):
    method: Optional[Method1] = Field(None, example='sov')
    options: Optional[DIDCreateOptions] = Field(
        None, description='To define a key type for a did:key'
    )
...
class DIFField(BaseModel):
    ...
    predicate: Optional[SubjectIsIssuer] = Field(None, description='Preference')
    purpose: Optional[str] = Field(None, description='Purpose')
...
class IndyRevRegDefValuePublicKeys(BaseModel):
    accumKey: Optional[IndyRevRegDefValuePublicKeysAccumKey] = None
...
class Constraints(BaseModel):
    ...
    status_active: Optional[StatusActive] = None
    status_revoked: Optional[StatusActive] = None
    status_suspended: Optional[StatusActive] = None
    subject_is_issuer: Optional[SubjectIsIssuer] = Field(
...
class IndyRevRegDefValue(BaseModel):
    issuanceType: Optional[IssuanceType] = Field(None, description='Issuance type')
    maxCredNum: Optional[int] = Field(
        None,
        description='Maximum number of credentials; registry size',
        example=10,
        ge=1,
    )
    publicKeys: Optional[IndyRevRegDefValuePublicKeys] = Field(
        None, description='Public keys'
    )
    tailsHash: Optional[str] = Field(
        None,
        description='Tails hash value',
        example='H3C2AVvLMv6gmMNam3uVAjZpfkcJCwDwnZn6z3wXmqPV',
        regex='^[123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz]{43,44}$',
    )
    tailsLocation: Optional[str] = Field(None, description='Tails file location')
...
class V10DiscoveryExchangeResult(BaseModel):
    results: Optional[V10DiscoveryRecord] = Field(
        None, description='Discover Features v1.0 exchange record'
    )
...
class IndyRevRegDef(BaseModel):
    ...
    revocDefType: Optional[RevocDefType] = Field(
        None,
...
class IssuerRevRegRecord(BaseModel):
    ...
    revoc_def_type: Optional[RevocDefType] = Field(
        None,
        description='Revocation registry type (specify CL_ACCUM)',
        example='CL_ACCUM',
    )
...
class V10PresentationExchange(BaseModel):
    ...
    verified: Optional[Verified] = Field(
        None,
...
class V20CredExRecord(BaseModel):
    ...
    state: Optional[State] = Field(
        None, description='Issue-credential exchange state', example='done'
    )
    thread_id: Optional[str] = Field(
        None,
        description='Thread identifier',
...
class V20PresExRecord(BaseModel):
    ...
    state: Optional[State1] = Field(None, description='Present-proof exchange state')
    thread_id: Optional[str] = Field(
        None,
        description='Thread identifier',
        example='3fa85f64-5717-4562-b3fc-2c963f66afa6',
