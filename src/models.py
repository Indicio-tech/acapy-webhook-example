...
#   filename:  https://raw.githubusercontent.com/Indicio-tech/acapy-openapi/0.7.2/openapi.yml
#   timestamp: 2022-04-06T01:44:03+00:00
...
class CredentialDefinitionSendRequest(BaseModel):
    revocation_registry_size: Optional[int] = Field(
        None, description="Revocation registry size", example=1000, ge=4.0, le=32768.0
    )
...
class QueryResult(BaseModel):
    results: Optional[Dict[str, Dict[str, Any]]] = Field(
        None, description="Query results keyed by protocol"
    )
...
class Schema1(BaseModel):
    ...
    seqNo: Optional[int] = Field(
        None, description="Schema sequence number", example=10, ge=1.0
    )
...
class TAAAcceptance(BaseModel):
    ...
    time: Optional[int] = Field(
        None, example=1640995199, ge=0.0, le=1.8446744073709552e19
    )
